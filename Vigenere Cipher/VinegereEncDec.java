public class VinegereEncDec {
   
   private static char[][] mat = rotateMatrix(createMatrix("KRYPTOS"));
   ...
   public static void main(String[] args) {
     ...
     */
      ...
      String t = encryption("TAKOHEMINEORADHJETE","SIGURIASIGURIASIGUR");   // per "KRYPTOS"
      String v = decription("EBJBXFFKUDBBBPZLDGU","SIGURIASIGURIASIGUR"); 
      ...
      String t1 = encryption("URIMEFITOREN","ERMIRERMIRER");
      String v1 = decription("XBQQUCZOVBBT","ERMIRERMIRER"); 
   ...
   public static String decription(String encMessage,String keyword) {
      ...
      int[] dec = decryptIt(encMessageLine,keywordLineNr);
   ...
   public static int[] decryptIt(char[] encryptedMessage, int[] keyword) {
   ...
   public static String encryption(String message,String keyword) {
      ...
      for(int i = 0; i < chipherText.length; i++) {
         ...
         chipherText[i] = mat[messageLineNr[i]] [keywordLineNr[i]];   
      }
