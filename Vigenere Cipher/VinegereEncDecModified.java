...
public class VinegereEncDecModified {
   ...
   public static void main(String[] args) {
     ...
     */
      ...
      String t = encryption("TAKOHEMINEORADHJETE","SIGURIASIGURIASIGUR",mat);   // per "KRYPTOS"
      String v = decription(t,"SIGURIASIGURIASIGUR",mat); 
